...
// ReminderHandler exposes authenticated reminder list and notification endpoints.
...
// Register mounts authenticated reminder routes under /api/v1/users/me/reminders.
